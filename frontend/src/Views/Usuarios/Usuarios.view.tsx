...
function createData(id: number, name: string, email: string, role: number) {
  return { id, name, email, role };
}

const rows = [
  createData(1, "Frozen yoghurt", "email@email.com", 1),
  createData(2, "Ice cream sandwich", "email@email.com", 2),
  createData(3, "Eclair", "email@email.com", 3),
];
  ...
  return (
    <div className={styles.container}>
      <div className={styles.title}>
        ...
        <Button variant="contained" color="primary" onClick={store.onClickOpenForm}>
          Novo
        </Button>
      </div>
      ...
      <Dialog open={store.isFormOpen} onClose={store.onClickCloseForm} scroll="paper">
          ...
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <TextField
                ...
                label="Senha"
                type="password"
                value={store.inputPassword}
                onChange={(event) => store.onChangeInputPassword(event.target.value)}
              />
            </Grid>
          </Grid>
        ...
        <DialogActions>
          ...
          <Button variant="contained" onClick={store.onClickSaveForm} color="primary">
            Salvar
          </Button>
        </DialogActions>
      </Dialog>
